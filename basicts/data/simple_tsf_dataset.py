...
class TimeSeriesForecastingDataset(BaseDataset):
    ...
    def __init__(self, dataset_name: str, train_val_test_ratio: List[float], mode: str, input_len: int,
                 output_len: int, overlap: bool = False, logger: logging.Logger = None) -> None:
        """
        ...
        Args:
            ...
            output_len (int): The length of the output sequence (number of future-normalized points to predict).
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        Returns:
            dict: A dictionary containing 'inputs' and 'target', where both are slices of the dataset corresponding to
                  the historical input data and future-normalized prediction data, respectively.
        """
